...
\begin{itemize}
  ...
  \item Utilizado en scripts de integración, p.ej. el ejemplo `argon-chemical-potential.py` adapta este truco.
\end{itemize}
\end{frame}
...
\begin{itemize}
  ...
  \item Barostato de Monte Carlo o Parrinello-Rahman aparece en los scripts de `simulateAmber.py`.
\end{itemize}
\end{frame}
