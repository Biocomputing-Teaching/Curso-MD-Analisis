...
\begin{enumerate}
  \item Convertir y limpiar trayectorias con \href{https://github.com/openmm/openmm/blob/master/examples/python-examples/simulatePdb.py}{\texttt{simulatePdb.py}} o \href{https://github.com/openmm/openmm/blob/master/examples/python-examples/simulateGromacs.py}{\texttt{simulateGromacs.py}}.
...
\begin{itemize}
  ...
  \item Documentamos con \href{https://github.com/openmm/openmm/blob/master/examples/python-examples/simulateAmber.py}{\texttt{simulateAmber.py}} y la salida en CSV para cada réplica.
\end{itemize}
\end{frame}
...
\begin{itemize}
  ...
  \item Las columnas representan cambios de dominios detectados por \href{https://github.com/openmm/openmm/blob/master/examples/python-examples/simulateCharmm.py}{\texttt{simulateCharmm.py}}.
\end{itemize}
\end{frame}
...
\begin{itemize}
  ...
  \item Relacionamos con \href{https://openmm.github.io/openmm-cookbook/latest/notebooks/tutorials/coarse_grained_polymer.html}{\texttt{coarse\_grained\_polymer.py}} para comparar modos lentos de polímeros y proteínas.
\end{itemize}
\end{frame}
...
\end{align*}
\begin{itemize}
  \item Comparar con \href{https://github.com/openmm/openmm/blob/master/examples/python-examples/argon-chemical-potential.py}{\texttt{argon-chemical-potential.py}} para validar.
...
\begin{itemize}
  ...
  \item Comparar perfiles unidimensionales con \href{https://github.com/openmm/openmm/blob/master/examples/python-examples/simulateAmber.py}{\texttt{simulateAmber.py}}.
...
\begin{itemize}
  \item Generar tablas de RMSD/RMSF/radio de giro con \href{https://github.com/openmm/openmm/blob/master/examples/python-examples/simulateCharmm.py}{\texttt{simulateCharmm.py}}.
