...
\begin{itemize}
  ...
  \item PyEMMA y Deeptime comparten la base de datos generada por `simulateAmber.py`.
\end{itemize}
\end{frame}
...
\begin{itemize}
  ...
  \item Usar `simulatePdb.py` para generar trayectorias y `OpenMMTools` para preparar `REST`.
\end{itemize}
\end{frame}
