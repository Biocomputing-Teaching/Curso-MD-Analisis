...
\end{itemize}
\begin{center}
  \includegraphics[width=0.68\linewidth]{verlet_integration.png}
\end{center}
{\tiny Schematic from Wikimedia Commons (CC BY-SA 4.0) illustrating the leapfrog/Verlet step.}
\end{frame}
...
\begin{center}
  \includegraphics[width=0.78\linewidth]{lipids_bilayer.pdf}
\end{center}
\end{frame}
...
\begin{center}
  \includegraphics[width=0.7\linewidth]{gsd_desolvation.png}
\end{center}
\end{frame}
...
\begin{center}
  \includegraphics[width=0.72\linewidth]{thermodynamiccycle.pdf}
\end{center}
\end{frame}
...
\begin{center}
  \includegraphics[width=0.7\linewidth]{gs_ts.png}
\end{center}
\end{frame}
...
\begin{center}
  \includegraphics[width=0.72\linewidth]{betacorrectedfel.pdf}
\end{center}
\end{frame}
