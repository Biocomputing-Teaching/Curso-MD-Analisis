...
\begin{itemize}
  ...
  \item The plotted curves for all macrostates overlap tightly, so powering the lag-5 transition matrix reproduces the directly estimated probabilities and the CK test endorses $\tau=0.5\ \mathrm{ns}$ for downstream analysis.
\end{itemize}
\end{frame}
