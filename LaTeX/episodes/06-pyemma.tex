...
\begin{itemize}
  \item \href{https://github.com/openmm/openmm/blob/master/examples/python-examples/simulateAmber.py}{simulateAmber.py} y \href{https://github.com/openmm/openmm/blob/master/examples/python-examples/simulateCharmm.py}{simulateCharmm.py} producen trayectorias DCD que alimentamos a PyEMMA\@.
...
\begin{itemize}
  ...
  \item La matriz de covarianza $C=\langle (\mathbf{x}-\bar{\mathbf{x}})(\mathbf{x}-\bar{\mathbf{x}})^T\rangle$ se proyecta.
...
\begin{itemize}
  ...
  \item Ajustamos priors a partir de las fuerzas detectadas en \href{https://github.com/openmm/openmm/blob/master/examples/python-examples/simulateAmber.py}{\texttt{simulateAmber.py}}.
\end{itemize}
\end{frame}
...
\begin{itemize}
  ...
  \item \href{https://github.com/openmm/openmm/blob/master/examples/python-examples/simulateGromacs.py}{\texttt{simulateGromacs.py}} proporciona las trayectorias de referencia.
\end{itemize}
\end{frame}
